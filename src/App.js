    ...
    <div id="page">
      <Router history={history} onUpdate={hashLinkScroll}>
        <header>
          ...
          <AmplienceSlot contentToRender={MegaMenu} slotId='4fddb07e-1b7d-435c-9b9b-511a6a5360de' slotType='https://www.megamenu' loadingIndicator={LoadingIndicator}/>
          <AmplienceSlot contentToRender={USP} slotId='38a1a157-8d87-4f4b-b301-11f7a472c216' slotType='https://header.usp.slot'/>
        </header>
        
        <Switch>
          <Route path="/" exact component={HomePage}></Route>
          <Route path="/gb/en/info/returning-goods" exact component={()=><AmplienceSlot contentToRender={Article} slotId='669d6fbb-76e6-41a7-a759-c75922621b05' slotType='https://article.slot' loadingIndicator={LoadingIndicator}/>}></Route>
